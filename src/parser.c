...
enum {
  ...
  sym_primitive_declaration = 72,
  sym__function_declaration_common = 73,
  sym_parameters = 74,
  sym_variable_declaration = 75,
  sym_import_declaration = 76,
  aux_sym_string_literal_repeat1 = 77,
  aux_sym_function_call_repeat1 = 78,
  aux_sym_sequence_expression_repeat1 = 79,
  aux_sym_record_expression_repeat1 = 80,
  aux_sym__declaration_chunk_repeat1 = 81,
  aux_sym__declaration_chunk_repeat2 = 82,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__lvalue, 1), SHIFT(58),
  ...
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_call, 3, .production_id = 4),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_function_call, 3, .production_id = 4),
  ...
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, .production_id = 7),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, .production_id = 7),
  ...
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence_expression, 3),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sequence_expression, 3),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_literal, 3),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_literal, 3),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let_expression, 3),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let_expression, 3),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_expression, 3, .production_id = 5),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record_expression, 3, .production_id = 5),
  ...
  [238] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2), SHIFT_REPEAT(132),
  [241] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2), SHIFT_REPEAT(126),
  [244] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2), SHIFT_REPEAT(125),
  [247] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2), SHIFT_REPEAT(140),
  [250] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunks, 2), SHIFT_REPEAT(124),
  ...
  [305] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunk_repeat2, 2), SHIFT_REPEAT(126),
  ...
  [313] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__declaration_chunk_repeat1, 2), SHIFT_REPEAT(132),
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 2),
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 4, .production_id = 28),
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__function_declaration_common, 2, .production_id = 6),
  [322] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 3, .production_id = 21),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primitive_declaration, 2, .production_id = 2),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_alias, 1),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_type, 3, .production_id = 26),
  [330] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type_declaration, 4, .production_id = 15),
  [332] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_type, 4, .production_id = 33),
  [334] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_declaration, 2, .production_id = 3),
  ...
  [342] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sequence_expression_repeat1, 2), SHIFT_REPEAT(60),
  [345] = {.entry = {.count = 1, .reusable = false}}, SHIFT(30),
  [347] = {.entry = {.count = 1, .reusable = true}}, SHIFT(103),
  [349] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_type_repeat1, 2, .production_id = 29), SHIFT_REPEAT(120),
  [352] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_type_repeat1, 2, .production_id = 29),
  [354] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_literal_repeat1, 2),
  [356] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_literal_repeat1, 2), SHIFT_REPEAT(103),
  ...
  [369] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_call_repeat1, 2), SHIFT_REPEAT(56),
  [372] = {.entry = {.count = 1, .reusable = true}}, SHIFT(129),
  [374] = {.entry = {.count = 1, .reusable = true}}, SHIFT(88),
  [376] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_expression_repeat1, 2, .production_id = 32), SHIFT_REPEAT(141),
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_expression_repeat1, 2, .production_id = 32),
  [381] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [383] = {.entry = {.count = 1, .reusable = true}}, SHIFT(98),
  [385] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [387] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_type_repeat1, 2, .production_id = 26),
  [389] = {.entry = {.count = 1, .reusable = true}}, SHIFT(120),
  [391] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [393] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__typed_field, 3, .production_id = 27),
